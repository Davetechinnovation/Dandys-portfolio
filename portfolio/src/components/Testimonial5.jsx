...
import img4 from "../assets/dandy-samuel.jpg";
import { FaQuoteLeft } from "react-icons/fa";

const Testimonial5 = ({ onClose, shouldClose }) => {
        ...
        <div className="flex gap-3 items-start ">
          ...
          <div className="text-white">
            <p className="font-semibold sm:text-[19px] text-[17px] flex gap-2 justify-between items-center ">
              <span>—  Samuel D., Product Manager</span>
              {onClose && (
                <span
                  onClick={handleClose}
            ...
            <p className="text-[15px] sm:text-[17px] italic ">
              “Dandy’s work ethic and talent are unmatched. He communicated
              clearly, met every milestone, and delivered a product we’re proud
              of. He’s not just a developer — he’s a partner in your success.”
            </p>
          </div>
        </div>
      </div>
